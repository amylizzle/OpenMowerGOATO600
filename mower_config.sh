...
export OM_NTRIP_RTCM_TIMEOUT_SEC=4.0
export OM_NTRIP_ADAPTIVE_RECONNECT=True
export OM_NTRIP_ADAPTIVE_BURST_MAX_ATTEMPTS=12
export OM_NTRIP_ADAPTIVE_BURST_WINDOW_SEC=60.0
export OM_NTRIP_ADAPTIVE_SLOW_AFTER_SEC=300.0
export OM_NTRIP_ADAPTIVE_SLOW_INTERVAL_SEC=300.0
export OM_NTRIP_RECONNECT_INITIAL_DELAY_SEC=10.0
export OM_NTRIP_RECONNECT_MAX_DELAY_SEC=300.0
export OM_NTRIP_RECONNECT_BACKOFF_MULTIPLIER=2.0
export OM_NTRIP_MAX_ATTEMPTS=0
